...
import com.coollen.radio.interfaces.IFragmentSearchable;
...
public class FragmentTabs extends Fragment implements IFragmentRefreshable, IFragmentSearchable {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View x = inflater.inflate(com.coollen.radio.R.layout.layout_tabs, null);
        final TabLayout tabLayout = (TabLayout) x.findViewById(com.coollen.radio.R.id.tabs);
        viewPager = (ViewPager) x.findViewById(com.coollen.radio.R.id.viewpager);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        if (country != null){
            adapter.addFragment(fragments[0], com.coollen.radio.R.string.action_local);
        }
        adapter.addFragment(fragments[1], com.coollen.radio.R.string.action_top_click);
        adapter.addFragment(fragments[2], com.coollen.radio.R.string.action_top_vote);
        adapter.addFragment(fragments[3], com.coollen.radio.R.string.action_changed_lately);
        adapter.addFragment(fragments[4], com.coollen.radio.R.string.action_currently_playing);
        adapter.addFragment(fragments[5], com.coollen.radio.R.string.action_tags);
        adapter.addFragment(fragments[6], com.coollen.radio.R.string.action_countries);
        adapter.addFragment(fragments[7], com.coollen.radio.R.string.action_languages);
        adapter.addFragment(fragments[8], com.coollen.radio.R.string.action_search);
