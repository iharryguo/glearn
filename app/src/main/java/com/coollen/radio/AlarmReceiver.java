...
import com.coollen.radio.IPlayerService;
        ...
        new AsyncTask<Void, Void, String>() {
            ...
            protected void onPostExecute(String result) {
                if (result != null) {
                    ...
                    Toast toast = Toast.makeText(context, context.getResources().getText(com.coollen.radio.R.string.error_station_load), Toast.LENGTH_SHORT);
                    toast.show();
                    if (wakeLock != null) {
                        wakeLock.release();
                        wakeLock = null;
