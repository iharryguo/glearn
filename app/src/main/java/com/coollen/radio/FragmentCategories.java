...
import com.coollen.radio.data.DataCategory;

import com.coollen.radio.BuildConfig;

import com.coollen.radio.adapters.ItemAdapterCategory;
...
public class FragmentCategories extends FragmentBase {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ItemAdapterCategory adapterCategory = new ItemAdapterCategory(com.coollen.radio.R.layout.list_item_category);
        ...
        rvCategories = (RecyclerView) view.findViewById(com.coollen.radio.R.id.recyclerViewStations);
