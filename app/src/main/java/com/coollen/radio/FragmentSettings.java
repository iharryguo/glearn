...
import com.coollen.radio.interfaces.IApplicationSelected;
...
public class FragmentSettings extends PreferenceFragmentCompat implements SharedPreferences.OnSharedPreferenceChangeListener, IApplicationSelected {
    ...
    public void onCreatePreferences(Bundle bundle, String s) {
        addPreferencesFromResource(com.coollen.radio.R.xml.preferences);
        ...
        findPreference("equalizer").setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                if (getContext().getPackageManager().resolveActivity(intent, 0) == null) {
                    Toast.makeText(getContext(), com.coollen.radio.R.string.error_no_equalizer_found, Toast.LENGTH_SHORT).show();
                } else {
        ...
        findPreference("show_statistics").setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            @Override
            public boolean onPreferenceClick(Preference preference) {
                ((ActivityMain)getActivity()).getToolbar().setTitle(com.coollen.radio.R.string.settings_statistics);
        ...
        findPreference("show_about").setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            @Override
            public boolean onPreferenceClick(Preference preference) {
                ((ActivityMain)getActivity()).getToolbar().setTitle(com.coollen.radio.R.string.settings_about);
    ...
    private void showAllMPDServers() {
        ...
        new AlertDialog.Builder(getContext())
                ...
                .setNeutralButton(com.coollen.radio.R.string.alert_select_mpd_server_add, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        editMPDServer(null);
                    }
                })
                .setTitle(com.coollen.radio.R.string.settings_view_mpd_servers)
                .show();
    }

    private void editMPDServer(final MPDServer server) {
        LayoutInflater inflater = getLayoutInflater();
        View server_view = inflater.inflate(com.coollen.radio.R.layout.layout_server_alert, null);
        final EditText name = (EditText) server_view.findViewById(com.coollen.radio.R.id.mpd_server_name);
        final EditText hostname = (EditText) server_view.findViewById(com.coollen.radio.R.id.mpd_server_hostname);
        final EditText port = (EditText) server_view.findViewById(com.coollen.radio.R.id.mpd_server_port);
        ...
        final AlertDialog dialog = new AlertDialog.Builder(getContext())
                .setView(server_view)
                .setPositiveButton(com.coollen.radio.R.string.alert_select_mpd_server_save, null)
                .setNeutralButton(com.coollen.radio.R.string.alert_select_mpd_server_remove, null)
                ...
                .setTitle(com.coollen.radio.R.string.alert_add_or_edit_mpd_server).create();
