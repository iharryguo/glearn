package com.coollen.radio.players.exoplayer;
...
import com.coollen.radio.recording.RecordableListener;
import com.coollen.radio.data.ShoutcastInfo;
import com.coollen.radio.data.StreamLiveInfo;
import com.coollen.radio.players.PlayerWrapper;
...
public class ExoPlayerWrapper implements PlayerWrapper, IcyDataSource.IcyDataSourceListener {
    ...
    public void playRemote(@NonNull OkHttpClient httpClient, @NonNull String streamUrl, @NonNull Context context, boolean isAlarm) {
        ...
        final int retryTimeout = prefs.getInt("settings_retry_timeout", 20);
