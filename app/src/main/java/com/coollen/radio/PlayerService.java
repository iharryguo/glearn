...
import com.coollen.radio.players.RadioPlayer;
import com.coollen.radio.recording.RecordingsManager;
import com.coollen.radio.recording.RunningRecordingInfo;
...
public class PlayerService extends Service implements RadioPlayer.PlayerListener {
    ...
    public static final String PLAYER_SERVICE_TIMER_UPDATE = "com.coollen.radio.timerupdate";
    public static final String PLAYER_SERVICE_STATUS_UPDATE = "com.coollen.radio.statusupdate";
    public static final String PLAYER_SERVICE_META_UPDATE = "com.coollen.radio.metaupdate";
    ...
    private final IPlayerService.Stub itsBinder = new IPlayerService.Stub() {
        ...
        public void startRecording() throws RemoteException {
            if (radioPlayer != null) {
                ...
                RecordingsManager recordingsManager = appMain.getRecordingsManager();
    ...
    public void onCreate() {
        ...
        radioIcon = ((BitmapDrawable) ResourcesCompat.getDrawable(getResources(), com.coollen.radio.R.drawable.ic_launcher, null));
    ...
    private int acquireAudioFocus() {
        ...
        if (result != AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
            ...
            toastOnUi(com.coollen.radio.R.string.error_grant_audiofocus);
        }
    ...
    private void sendMessage(String theTitle, String theMessage, String theTicker) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel notificationChannel = new NotificationChannel(NOTIFICATION_CHANNEL_ID, itsContext.getString(R.string.app_name), NotificationManager.IMPORTANCE_LOW);
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(itsContext, NOTIFICATION_CHANNEL_ID)
                ...
                .setSmallIcon(com.coollen.radio.R.drawable.ic_play_arrow_white_24dp)
                .setLargeIcon(radioIcon.getBitmap());
        RadioPlayer.PlayState currentPlayerState = radioPlayer.getPlayState();

        RemoteViews remoteViews = new RemoteViews(itsContext.getPackageName(), R.layout.layout_player_notify_control);
        remoteViews.setTextViewText(R.id.control_radio_name, theTitle);
        remoteViews.setTextViewText(R.id.control_radio_status, theMessage);
        notificationBuilder.setContent(remoteViews);
        remoteViews.setOnClickPendingIntent(R.id.control_radio_exit, pendingIntentStop);
        if (currentPlayerState == RadioPlayer.PlayState.Playing) {
            Intent pauseIntent = new Intent(itsContext, PlayerService.class);
            pauseIntent.setAction(ACTION_PAUSE);
            remoteViews.setImageViewResource(R.id.control_radio_pause, R.drawable.ic_pause_white_24dp);
            PendingIntent pendingIntentPause = PendingIntent.getService(itsContext, 0, pauseIntent, 0);
            remoteViews.setOnClickPendingIntent(R.id.control_radio_pause, pendingIntentPause);
            ...
            remoteViews.setImageViewResource(R.id.control_radio_pause, R.drawable.ic_play_arrow_white_24dp);
            remoteViews.setOnClickPendingIntent(R.id.control_radio_pause, pendingIntentResume);
        }
        // remoteViews.setInt(R.id.control_radio_pause, "setColorFilter", R.color.colorAccent);
        // remoteViews.setInt(R.id.control_radio_exit, "setColorFilter", R.color.colorAccent);
    ...
    private void updateNotification(RadioPlayer.PlayState playState) {
        switch (playState) {
            case Idle:
                ...
                break;
            case PrePlaying:
                sendMessage(currentStationName, itsContext.getResources().getString(com.coollen.radio.R.string.notify_pre_play), itsContext.getResources().getString(com.coollen.radio.R.string.notify_pre_play));
                break;
            case Playing:
                ...
                if (!TextUtils.isEmpty(title)) {
                    ...
                    sendMessage(currentStationName, itsContext.getResources().getString(com.coollen.radio.R.string.notify_play), currentStationName);
                }
                ...
                break;
            case Paused:
                sendMessage(currentStationName, itsContext.getResources().getString(com.coollen.radio.R.string.notify_paused), currentStationName);
                break;
        }
    }
